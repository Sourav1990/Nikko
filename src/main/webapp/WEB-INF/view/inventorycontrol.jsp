...
<div class="admin-panel clearfix">
  <div class="slidebar">
    ...
    <ul>
      <li><a href="${cp}/adminproductgor" id="targeted">Manage Products</a></li>
      <li><a href="${cp}/admincatgor">Manage Categories</a></li>
      <li><a href="${cp}/adminsuppliergor">Manage Suppliers</a></li>
    </ul>
  </div>
</div>
</body>
