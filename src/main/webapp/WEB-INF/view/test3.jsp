...
<body>
	...
	<header>
		<a class="active" href="#">HOME</a> <a href="${cp}/test">GALLERIA</a>
		<a href="${cp}/mcart">PRODUCTS</a> <a href="${cp}/service">SERVICE
	...
	<footer class="footer">
		<div class="footer-left col-md-4 col-sm-6">
			<p class="about">
				<span> About the company</span> An exclusive galleria for all the
				camera lovers. Just step in once to see the wide range of
				collection. Surely, not to be missed.
			</p>
			<div class="icons">
		...
		<div class="footer-center col-md-4 col-sm-6">
			<div>
				...
				<p>
					<span>14/1A,Wellington Street,Nikko Corporation Pvt.Ltd</span>
					Kolkata, INDIA
				</p>
			</div>
			<div>
