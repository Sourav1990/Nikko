...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-8">
				<form:form method="POST" action="${cp}/add" modelAttribute="product"
						...
						<c:if test="${not empty productlist}">
							<tbody>
								<c:forEach items="${productlist}" var="data">
									...
									<tr>
										<td><img alt=""
											src="${cp}/resources/images/${data.product_id}.jpg"
										...
										<td><a href="<c:url value='/update${data.product_id}' />"><span
												class="glyphicon glyphicon-pencil btn btn-primary"></span></a></a></td>
										<td><a href="<c:url value='/delete${data.product_id}'/>">
